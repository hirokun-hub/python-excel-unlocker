...
- [x] 2. normalize_vercel_project.py の .github/scripts/ への移動
...
- [x] 4. build-frontend.yml のインライン Python コード置き換え
...
- [ ] 9. GitHub Actions での統合テスト
  ...
  - `validate-environment` カスタムアクションでの `validate-ci-environment.py` 実行テスト（要タスク3,6完了）
